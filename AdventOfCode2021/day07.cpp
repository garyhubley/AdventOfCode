...
static std::vector<int> debugCrabLocations = { 16, 1, 2, 0, 4, 2, 7, 1, 2, 14 };
...
void day07Part01() {
	...
	//sort 
	std::sort(crabLocations.begin(), crabLocations.end());

	// find median
	auto med = crabLocations[crabLocations.size() / 2];
